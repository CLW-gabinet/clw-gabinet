...
export default function ChildrenControlCardInfo() {
    const { id } = useParams()
            ...
            <div className="display-center">
                <div className="karta-papier">
                    ...
                    <div className="karta-naglowek">
                        <strong>KARTA BADANIA OPTOMETRYCZNEGO – Dziecko Kontrolna®</strong>
                        <span>
                    ...
                    <DottedLine label="Data i diagnoza ostatnich badań:" value={d.ostatnie_badania} />

                    <DottedLine label="Stosowanie się do zleceń:" value={d.stosowanie_zlecenia} />

                    <DottedLine label="Skarga główna:" value={d.skarga_glowna} />
                    ...
                    <div className="karta-linia">
                        <strong>Sprawność</strong> ({d.sprawnosc || '–'}):&nbsp;
                        OP: {d.sprawnosc_op || '–'} {d.sprawnosc_op_wybor || 'cykl'}&nbsp;
                        OL: {d.sprawnosc_ol || '–'} {d.sprawnosc_ol_wybor || 'cykl'}&nbsp;
                    </div>
